-- Migration: tambah 'Kreatif' ke CHECK constraint public.member_professionals.profession_category
-- Kategori baru untuk profesi kreator/pekerja seni (kaligrafer, desainer, seniman, dll) —
-- lihat apps/web/lib/professional-types.ts PROFESSION_CATEGORIES + PROFESSION_TYPES_BY_CATEGORY.
...
-- Jalankan: docker compose exec -T postgres psql -U jalakarta -d jalakarta < packages/db/migrations/0043_member_professionals_kreatif_category.sql
