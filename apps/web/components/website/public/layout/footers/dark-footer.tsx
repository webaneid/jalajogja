              ...
              <ul className="space-y-3 text-sm text-gray-400 mt-2">
                ...
                {phone && (
                  <li className="flex items-center gap-2">
                    ...
                    <a href={`tel:${phone}`} className="hover:text-white transition-colors">{displayPhone(phone)}</a>
                  </li>
                )}
                {whatsapp && cs.contact_whatsapp && (
                  <li className="flex items-center gap-2">
                    ...
                    <a href={whatsapp} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">{displayPhone(cs.contact_whatsapp)}</a>
                  </li>
                )}
              </ul>
            </div>
