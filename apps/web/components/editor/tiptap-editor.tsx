    ...
    editorProps: {
      attributes: {
        class: [
          ...
          // Direct selectors — lebih andal dari prose modifier di Tailwind v4 + contenteditable
          "[&_p]:my-3",
          "[&_h1]:mt-8 [&_h1]:mb-3 [&_h1]:font-bold [&_h1]:tracking-tight",
          "[&_h2]:mt-6 [&_h2]:mb-3 [&_h2]:font-semibold [&_h2]:tracking-tight",
