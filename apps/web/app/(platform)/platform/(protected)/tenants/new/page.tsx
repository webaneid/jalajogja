    ...
    <div className="max-w-xl space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs text-muted-foreground">Huruf kecil, angka, dan dash saja. Minimal 3 karakter. Tidak bisa diubah setelah disimpan.</p>
        </div>
        ...
        {(type === "marhalah" || type === "forum") && (
          <div className="space-y-1">
            ...
            <p className="text-xs text-muted-foreground">
              {type === "marhalah"
                ? "Jika marhalah ini di bawah satu cabang tertentu, isi UUID cabang tersebut."
                : "Jika forum ini dikelola oleh satu cabang, isi UUID cabang pengelola."}
            </p>
          </div>
        )}
