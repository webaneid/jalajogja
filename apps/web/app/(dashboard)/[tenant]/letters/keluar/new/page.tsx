...
export default async function SuratKeluarNewPage({
  ...
  // Fetch role per member untuk AvailableOfficer
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div>
        <h1 className="text-xl font-semibold">Surat Keluar Baru</h1>
      </div>
      ...
      <LetterForm
        ...
        templates={templates.map((t) => ({
          ...t, type: t.type ?? "outgoing", subject: t.subject ?? null, body: t.body ?? null,
        }))}
        officers={officers}
