...
- [ ] **Image System Phase D — Autocrop**: D1 = ganti `position:"center"` → `"attention"` (libvips smart crop, 1 baris); D2 = manual crop override via UI editor (`react-image-crop`) + `crop_data` kolom + `/api/media/[id]/recrop`. Detail di `docs/arsitektur-image.md` bagian Phase D.
